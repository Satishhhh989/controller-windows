...
echo Adding inbound UDP firewall rule for controller port 5000 (Private profile)...
netsh advfirewall firewall add rule name="Phone Racing Wheel UDP Bridge" dir=in action=allow protocol=UDP localport=5000 profile=private

echo Adding inbound UDP firewall rule for discovery port 5152 (Private profile)...
netsh advfirewall firewall add rule name="Phone Racing Wheel Discovery" dir=in action=allow protocol=UDP localport=5152 profile=private
